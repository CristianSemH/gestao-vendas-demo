...
import { getTipoSituacaosById, addTipoSituacao, updateTipoSituacao } from '../../services/tipoSituacaoVenda';
                        ...
                        <Form onSubmit={handleSubmit(handleUpdateCreate)}>
                            ...
                            <div className="col-12 mt-5">
                                ...
                                <div className='float-end'>
                                    <button className='button-custom button-custom-secondary' onClick={() => navigate('/tiposituacaovenda')}> Voltar</button>
                                </div>
                            </div>
